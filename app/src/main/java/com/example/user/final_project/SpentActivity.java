...
public class SpentActivity extends AppCompatActivity {
    ...
    URLSpent url=new URLSpent();
    JSONArray pro;
    CustomAdapterSpent custom;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        custom=new CustomAdapterSpent(this,arrayList1,arrayList2,arrayList3);
        //list.setAdapter(custom);
        new DataReceive().execute();
        textView5=(TextView) findViewById(R.id.textview_date);
        long date = System.currentTimeMillis();
        SimpleDateFormat sdf = new SimpleDateFormat("MMMM dd, yyyy");
        String dateString = sdf.format(date);
        textView5.setText(dateString);
    }
    public void btn_spent(View view){
        editText_amount=(EditText) findViewById(R.id.editText_amount_spent);
        editText_purpose=(EditText) findViewById(R.id.editText_purpose_spent);
    ...
    public class DataSend extends AsyncTask<String, String, String> {
        ...
        ProgressDialog progressDialog = new ProgressDialog(SpentActivity.this);
    ...
    public class DataReceive extends AsyncTask <String, String, String>{
        ...
        ProgressDialog dialog=new ProgressDialog(SpentActivity.this);
